...
var (
	...
	// CONNTRACK_WIDE_TITLE adds OFFLOAD_STATE and HW_PKTS at rightmost positions (D-13).
	CONNTRACK_WIDE_TITLE = []string{"Service Name", "destIP", "srcIP", "dPort", "sPort", "proto", "ident", "state", "act", "packets", "bytes", "OFFLOAD_STATE", "HW_PKTS"}
	LOADBALANCER_TITLE   = []string{"Ext IP", "Port", "Proto", "Name", "Mark", "Sel", "Mode", "Catalog", "Backend-Proto", "# of Endpoints", "Timeout", "Monitor"}
	// Phase 65 D-13: OFFLOAD_STATE + HW_PKTS added at rightmost positions.
	LOADBALANCER_WIDE_TITLE = []string{"Ext IP", "Sec IPs", "Sources", "Host", "PathPrefix", "MatchMode", "Port", "Proto", "Name", "Mark", "Sel", "Mode", "Catalog", "TraceType", "Backend-Proto", "SessionHdr", "CHWBL-Lvl", "CHWBL-Flags", "CHWBL-LF", "CHWBL-Repl", "CHWBL-Salt", "Endpoint", "EPort", "Weight", "State", "Counters", "OFFLOAD_STATE", "HW_PKTS"}
