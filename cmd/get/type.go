...
var (
	...
	LOADBALANCER_TITLE       = []string{"Ext IP", "Port", "Proto", "Name", "Mark", "Sel", "Mode", "Catalog", "Backend-Proto", "# of Endpoints", "Timeout", "Monitor"}
	LOADBALANCER_WIDE_TITLE  = []string{"Ext IP", "Sec IPs", "Sources", "Host", "PathPrefix", "MatchMode", "Port", "Proto", "Name", "Mark", "Sel", "Mode", "Catalog", "TraceType", "Backend-Proto", "SessionHdr", "CHWBL-Lvl", "CHWBL-Flags", "CHWBL-LF", "CHWBL-Repl", "CHWBL-Salt", "Endpoint", "EPort", "Weight", "State", "Counters"}
	...
	IPFILTER_TITLE           = []string{"IP Prefix", "Action", "Zone", "Priority", "Packets", "Bytes"}
	SYNFLOOD_TITLE           = []string{"Status", "SYN Threshold", "Cookie Threshold", "Whitelist IPs", "Total SYNs", "Blocked", "Passed", "Cookie Acts", "Unique IPs"}
	...
	TRACING_STATUS_TITLE     = []string{"Enabled", "Sampling Rate", "Config Version"}
	TRACING_STATISTICS_TITLE = []string{"Total Events", "Sampled Events", "Dropped Events", "TCP Events", "SCTP Events"}
	TRACING_CONNECTION_TITLE = []string{"New", "Established", "Closed (Clean)", "Closed (Timeout)", "Closed (Reset)", "Errors"}
	LLM_CATALOG_TITLE        = []string{"NAME", "DESCRIPTION", "Version", "BUILTIN", "QUEUE_WEIGHT", "SWAP_WEIGHT", "CACHE_WEIGHT"}
	LLM_CATALOG_DETAIL_TITLE = []string{"NAME", "DESCRIPTION", "Version", "BUILTIN", "QUEUE_WEIGHT", "SWAP_WEIGHT", "CACHE_WEIGHT", "Queue_High_threshold", "Queue_Critical_threshold", "Swap_High_threshold", "Swap_Critical_threshold", "Cache_High_threshold", "Cache_Critical_threshold"}
	SECURITY_RATE_TITLE      = []string{"status", "synThreshold", "cookieThreshold", "connRate", "ratePerSec", "concurrentLimit", "udpEnabled", "udpPkt", "udpBW(MB)", "whitelist", "synBlocked", "synPassed", "connBlocked", "connPassed", "concurrentBlocked", "udpBlocked", "udpPassed", "uniqueIps"}
	SNI_TITLE                = []string{"SNI Host", "Certificate Name"}
	TRACE_TITLE              = []string{"Endpoint", "Protocol", "Use TLS", "Skip TLS Verify", "Connected", "Header"}
)
