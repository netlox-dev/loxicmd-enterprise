...
`,
	...
	GetCmd.AddCommand(NewGetIPFilterCmd(restOptions))
	GetCmd.AddCommand(NewGetSYNFloodCmd(restOptions))
	GetCmd.AddCommand(NewGetSecurityRateCmd(restOptions))
	...
	GetCmd.AddCommand(NewGetSNICertificateCmd(restOptions))
	GetCmd.AddCommand(NewGetLLMCatalogsCmd(restOptions))
	GetCmd.AddCommand(NewGetLLMCatalogCmd(restOptions))
