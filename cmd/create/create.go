...
`,
	...
	createCmd.AddCommand(NewCreateIPFilterCmd(restOptions))
	createCmd.AddCommand(NewCreateSYNFloodCmd(restOptions))
	createCmd.AddCommand(NewCreateSecurityRateCmd(restOptions))
	...
	createCmd.AddCommand(NewCreateSNICertificateCmd(restOptions))
	createCmd.AddCommand(NewCreateL4TraceCmd(restOptions))
