...
Delete - Service type external load-balancer, Vlan, Vxlan, Qos Policies,
	...
	deleteCmd.AddCommand(NewDeleteIPFilterCmd(restOptions))
	deleteCmd.AddCommand(NewDeleteSYNFloodCmd(restOptions))
	deleteCmd.AddCommand(NewDeleteSecurityRateCmd(restOptions))
	...
	deleteCmd.AddCommand(NewDeleteSNICertificateCmd(restOptions))
	deleteCmd.AddCommand(NewDeleteTraceCmd(restOptions))
	deleteCmd.AddCommand(NewDeleteL4TraceCmd(restOptions))
