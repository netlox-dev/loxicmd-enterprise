...
func (l *CommonAPI) DeleteWithBody(ctx context.Context, modelbody interface{}) (*http.Response, error) {
	...
	deleteURL := l.GetUrlString()
	return l.restClient.DELETE_WITH_BODY(ctx, deleteURL, body)
}
...
func (l *CommonAPI) Reset(ctx context.Context) (*http.Response, error) {
	resetURL := l.GetUrlString()
	return l.restClient.PUT(ctx, resetURL, nil)
}
